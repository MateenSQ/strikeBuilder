namespace StrikeBuilderMVC.Models
{
    public class MockStrikesRepository : IMockStrikesRepository
    {
        public IEnumerable<Strike> AllStrikes => new List<Strike> 
        {
            ...
            new Strike {Id = 3, Name="Right Hook", Description="Lorem Ipsum"},
            new Strike {Id = 3, Name="Uppercut", Description="Lorem Ipsum"},
            new Strike {Id = 3, Name="Left Round Kick", Description="Lorem Ipsum"},
            new Strike {Id = 3, Name="Right Round Kick", Description="Lorem Ipsum"},
        };
